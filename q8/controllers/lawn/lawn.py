    ...
    def __init__(self,robot, help, rebb_graph):
        ...
        while robot.step(self.time_step) != -1:
            ...
            if not self.reached_goal: 
                ...
                # if not self.end:
                heading_angle = help.get_heading_angle(self.epuck.getOrientation())
                desire_angle = help.angel_line_horizontal((self.pos[0],self.pos[1]),multi_goals[self.count_lane]) 
                ...
                print("angle:", desire_angle,heading_angle,(heading_angle - desire_angle), (desire_angle - heading_angle), angle_diff)
                    
                if (heading_angle - desire_angle) > 0.2:
                ...
                elif 0 < (heading_angle - desire_angle) < 0.2:
                    left_speed = self.max_speed *0.5
                    right_speed = self.max_speed *0.5
                    self.left_motor.setVelocity(left_speed)
                    self.right_motor.setVelocity(right_speed)
